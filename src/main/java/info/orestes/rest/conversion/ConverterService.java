 ...
 * representations as well as for response entities. </p> <p> <p> To handle the conversion accurately the content will
 * be processed in two steps. </p> <p> <ul> <li>For in bound messages: raw data -&gt; interpretable java representation
 * -&gt; java object <li>For out bound messages: java object -&gt; interpretable java representation -&gt; raw data
 * </ul> <p> <p> The conversion between raw data &lt;-&gt; interpretable java representation will be handled by a {@link
